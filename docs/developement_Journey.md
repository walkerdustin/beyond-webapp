...
user agent stylesheet is anoying me I copied the reset style thing from https://github.com/filipelinhares/ress 
into my scss
...
## try out the official tailwind installation, to fix the bug
https://tailwindcss.com/docs/guides/sveltekit but it did not change anything
...
about half way through I started to use github copilot, and I gotta say, it is actually pretty good
